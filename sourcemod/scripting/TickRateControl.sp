...
{
	name 	= "TickRate Control",
	author 	= "Rostu",
	version = "1.1",
	url 	= "https://vk.com/rostu13 | Discord: Rostu#7917"
};
...
Address g_pTickInterval; // m_flTickInterval + SV_StartSound;
Address g_pIntervalPerTick;  // host_state_interval_per_tick + CBaseServer::SpawnServer
...
void SetTickRate(int iTick)
{
	...
	if(hForward == null) 
		hForward = new GlobalForward("TickRate_OnTickRateChanged", ET_Ignore, Param_Cell, Param_Cell); // public void TickRate_OnTickRateChanged(float fOldTick, float fNewTick)
...
void ReadGameData()
{
	...
	Address pSpawnServer 	= hGameData.GetAddress("CBaseServer::SpawnServer");
