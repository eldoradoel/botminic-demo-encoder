...
Handle g_UserSettingCookies[view_as<int>(UserSetting_NumSettings)];
bool g_UserSettingDefaults[view_as<int>(UserSetting_NumSettings)];
char g_UserSettingDisplayName[view_as<int>(UserSetting_NumSettings)][USERSETTING_DISPLAY_LENGTH];
